...
class SegmentationDoubleAdvDataset(BaseDataset):
    ...
    def get_raw_inputs(self, index):
        ...
        raw_inputs['label3'] = Image.open(A_path[:-4] + '3.png')
    ...
    def preprocess_inputs(self, raw_inputs, params):
        ...
        outputs['label3'] = transform_label(raw_inputs['label3']) * 255.0
    ...
    def name(self):
        return 'SegmentationDoubleAdvDataset'

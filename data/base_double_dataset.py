...
def get_transform_params(full_size, inst_info=None, class_of_interest=None,
                         config=None, bbox=None, sub_bbox=None, target_box=None, random_crop=True):
...
def crop_single_object_with_bbox(bbox, w, h, img_to_obj_ratio,
                                 patch_to_obj_ratio, target_size, sub_bbox=None, target_box=None, random_crop=True):
...
def get_transform_fn(opt, params, method=Image.BICUBIC, normalize=True, is_context=True, resize=True):
    ...
    if opt.resize_or_crop == 'scale_width':
        ...
        transform_list.append(
            transforms.Lambda(lambda img: __select_region(img, crop_pos, opt.fineSize, method, resize)))

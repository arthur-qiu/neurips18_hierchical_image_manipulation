...
class Pix2PixHDModel_condImgAdv(BaseModel):
    def __init__(self, opt):
        ...
        #init segnet
        self.seg_mean = Variable([0.29010095242892997, 0.32808144844279574, 0.28696394422942517]).cuda()
        self.seg_std = Variable([0.1829540508368939, 0.18656561047509476, 0.18447508988480435]).cuda()
